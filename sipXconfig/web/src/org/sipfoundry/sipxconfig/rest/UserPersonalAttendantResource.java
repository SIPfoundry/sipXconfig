...
public class UserPersonalAttendantResource extends UserResource {
    private static final Log LOG = LogFactory.getLog(UserPersonalAttendantResource.class);
    ...
    public void storeRepresentation(Representation entity) throws ResourceException {
        if (Boolean.TRUE == getUserToQuery().hasPermission(PermissionName.PERSONAL_AUTO_ATTENDANT)) {
