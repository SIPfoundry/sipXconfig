        ...
        settings: {
          ...
          user: {
            ...
            vm: {
              ...
              language: [
            	  { name: 'af-ZA', val: 'af-ZA' },
            	  { name: 'am-ET', val: 'am-ET' },
            	  { name: 'hy-AM', val: 'hy-AM' },
            	  { name: 'az-AZ', val: 'az-AZ' },
            	  { name: 'id-ID', val: 'id-ID' },
            	  { name: 'ms-MY', val: 'ms-MY' },
            	  { name: 'bn-BD', val: 'bn-BD' },
            	  { name: 'bn-IN', val: 'bn-IN' },
            	  { name: 'ca-ES', val: 'ca-ES' },
            	  { name: 'cs-CZ', val: 'cs-CZ' },
            	  { name: 'da-DK', val: 'da-DK' },
            	  { name: 'de-DE', val: 'de-DE' },
            	  { name: 'en-AU', val: 'en-AU' },
            	  { name: 'en-CA', val: 'en-CA' },
            	  { name: 'en-GH', val: 'en-GH' },
            	  { name: 'en-GB', val: 'en-GB' },
            	  { name: 'en-IN', val: 'en-IN' },
            	  { name: 'en-IE', val: 'en-IE' },
            	  { name: 'en-KE', val: 'en-KE' },
            	  { name: 'en-NZ', val: 'en-NZ' },
            	  { name: 'en-NG', val: 'en-NG' },
            	  { name: 'en-PH', val: 'en-PH' },
            	  { name: 'en-ZA', val: 'en-ZA' },
            	  { name: 'en-TZ', val: 'en-TZ' },
            	  { name: 'en-US', val: 'en-US' },
            	  { name: 'es-AR', val: 'es-AR' },
            	  { name: 'es-BO', val: 'es-BO' },
            	  { name: 'es-CL', val: 'es-CL' },
            	  { name: 'es-CO', val: 'es-CO' },
            	  { name: 'es-CR', val: 'es-CR' },
            	  { name: 'es-EC', val: 'es-EC' },
            	  { name: 'es-SV', val: 'es-SV' },
            	  { name: 'es-ES', val: 'es-ES' },
            	  { name: 'es-US', val: 'es-US' },
            	  { name: 'es-GT', val: 'es-GT' },
            	  { name: 'es-HN', val: 'es-HN' },
            	  { name: 'es-MX', val: 'es-MX' },
            	  { name: 'es-NI', val: 'es-NI' },
            	  { name: 'es-PA', val: 'es-PA' },
            	  { name: 'es-PY', val: 'es-PY' },
            	  { name: 'es-PE', val: 'es-PE' },
            	  { name: 'es-PR', val: 'es-PR' },
            	  { name: 'es-DO', val: 'es-DO' },
            	  { name: 'es-UY', val: 'es-UY' },
            	  { name: 'es-VE', val: 'es-VE' },
            	  { name: 'eu-ES', val: 'eu-ES' },
            	  { name: 'fil-PH', val: 'fil-PH' },
            	  { name: 'fr-CA', val: 'fr-CA' },
            	  { name: 'fr-FR', val: 'fr-FR' },
            	  { name: 'gl-ES', val: 'gl-ES' },
            	  { name: 'ka-GE', val: 'ka-GE' },
            	  { name: 'gu-IN', val: 'gu-IN' },
            	  { name: 'hr-HR', val: 'hr-HR' },
            	  { name: 'zu-ZA', val: 'zu-ZA' },
            	  { name: 'is-IS', val: 'is-IS' },
            	  { name: 'it-IT', val: 'it-IT' },
            	  { name: 'jv-ID', val: 'jv-ID' },
            	  { name: 'kn-IN', val: 'kn-IN' },
            	  { name: 'km-KH', val: 'km-KH' },
            	  { name: 'lo-LA', val: 'lo-LA' },
            	  { name: 'lv-LV', val: 'lv-LV' },
            	  { name: 'lt-LT', val: 'lt-LT' },
            	  { name: 'hu-HU', val: 'hu-HU' },
            	  { name: 'ml-IN', val: 'ml-IN' },
            	  { name: 'mr-IN', val: 'mr-IN' },
            	  { name: 'nl-NL', val: 'nl-NL' },
            	  { name: 'ne-NP', val: 'ne-NP' },
            	  { name: 'nb-NO', val: 'nb-NO' },
            	  { name: 'pl-PL', val: 'pl-PL' },
            	  { name: 'pt-BR', val: 'pt-BR' },
            	  { name: 'pt-PT', val: 'pt-PT' },
            	  { name: 'ro-RO', val: 'ro-RO' },
            	  { name: 'si-LK', val: 'si-LK' },
            	  { name: 'sk-SK', val: 'sk-SK' },
            	  { name: 'sl-SI', val: 'sl-SI' },
            	  { name: 'su-ID', val: 'su-ID' },
            	  { name: 'sw-TZ', val: 'sw-TZ' },
            	  { name: 'sw-KE', val: 'sw-KE' },
            	  { name: 'fi-FI', val: 'fi-FI' },
            	  { name: 'sv-SE', val: 'sv-SE' },
            	  { name: 'ta-IN', val: 'ta-IN' },
            	  { name: 'ta-SG', val: 'ta-SG' },
            	  { name: 'ta-LK', val: 'ta-LK' },
            	  { name: 'ta-MY', val: 'ta-MY' },
            	  { name: 'te-IN', val: 'te-IN' },
            	  { name: 'vi-VN', val: 'vi-VN' },
            	  { name: 'tr-TR', val: 'tr-TR' },
            	  { name: 'ur-PK', val: 'ur-PK' },
            	  { name: 'ur-IN', val: 'ur-IN' },
            	  { name: 'el-GR', val: 'el-GR' },
            	  { name: 'bg-BG', val: 'bg-BG' },
            	  { name: 'ru-RU', val: 'ru-RU' },
            	  { name: 'sr-RS', val: 'sr-RS' },
            	  { name: 'uk-UA', val: 'uk-UA' },
            	  { name: 'he-IL', val: 'he-IL' },
            	  { name: 'ar-IL', val: 'ar-IL' },
            	  { name: 'ar-JO', val: 'ar-JO' },
            	  { name: 'ar-AE', val: 'ar-AE' },
            	  { name: 'ar-BH', val: 'ar-BH' },
            	  { name: 'ar-DZ', val: 'ar-DZ' },
            	  { name: 'ar-SA', val: 'ar-SA' },
            	  { name: 'ar-IQ', val: 'ar-IQ' },
            	  { name: 'ar-KW', val: 'ar-KW' },
            	  { name: 'ar-MA', val: 'ar-MA' },
            	  { name: 'ar-TN', val: 'ar-TN' },
            	  { name: 'ar-OM', val: 'ar-OM' },
            	  { name: 'ar-PS', val: 'ar-PS' },
            	  { name: 'ar-QA', val: 'ar-QA' },
            	  { name: 'ar-LB', val: 'ar-LB' },
            	  { name: 'ar-EG', val: 'ar-EG' },
            	  { name: 'fa-IR', val: 'fa-IR' },
            	  { name: 'hi-IN', val: 'hi-IN' },
            	  { name: 'th-TH', val: 'th-TH' },
            	  { name: 'ko-KR', val: 'ko-KR' },
            	  { name: 'cmn-Hant-TW', val: 'cmn-Hant-TW' },
            	  { name: 'yue-Hant-HK', val: 'yue-Hant-HK' },
            	  { name: 'ja-JP', val: 'ja-JP' },
            	  { name: 'cmn-Hans-HK', val: 'cmn-Hans-HK' },
            	  { name: 'cmn-Hans-CN', val: 'cmn-Hans-CN' },
              ]
            },
            ...
            init: function () {
              ...
              function setVmSelected () {
                ...
                var language = angular.copy(secondary.settings.user.vm.main.transcribeLanguage);
                for (i = 0; i < secondary.settings.user.vm.language.length; i++) {
	              if (language === secondary.settings.user.vm.language[i].val) {
	                secondary.settings.user.vm.transcribeLanguage = secondary.settings.user.vm.language[i];
	              }
	            };
              }
            },
            ...
            save: function () {
              ...
              function saveVm() {
                ...
                secondary.settings.user.vm.main.transcribeLanguage = secondary.settings.user.vm.transcribeLanguage.val;
