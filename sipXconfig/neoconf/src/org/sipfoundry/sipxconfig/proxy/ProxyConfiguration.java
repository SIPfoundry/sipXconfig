...
public class ProxyConfiguration implements ConfigProvider, ApplicationContextAware {
    ...
    void write(Writer wtr, ProxySettings settings, Location location, Domain domain, boolean isCdrOn)
        ...
        config.write("SIPX_PROXY_HOOK_LIBRARY.995_pagingalert",
                "$(sipx.SIPX_LIBDIR)/authplugins/libPagingAlert.so");
        config.write("SIPX_TRAN_HOOK_LIBRARY.995_maskcallerid",
                "$(sipx.SIPX_LIBDIR)/transactionplugins/libCallerIdMasking.so");
