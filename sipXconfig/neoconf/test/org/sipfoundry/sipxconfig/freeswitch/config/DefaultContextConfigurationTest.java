...
public class DefaultContextConfigurationTest {
    ...
    public void testMinimalConfig() throws Exception {
        ...
        m_configuration.write(actual, location, bridge, false, false, null, extensions, false, true, null);
    ...
    public void testExtensionsConfig() throws Exception {
        ...
        m_configuration.write(actual, location, bridge, false, false, null, extensions, true, true, 10);
    ...
    public void testAuthCodesConfig() throws Exception {
        ...
        Bridge bridge = new Bridge();
        List<FreeswitchExtension> extensions = Collections.emptyList();
        m_configuration.write(actual, location, bridge, true, false, null, extensions, false, true, 30);
    ...
    public void testVMsConfig() throws Exception {
        ...
        Bridge bridge = new Bridge();
        List<FreeswitchExtension> extensions = Collections.emptyList();
        m_configuration.write(actual, manila, bridge, false, false, null, extensions, false, true, 35);
    ...
    public void testParkConfig() throws Exception {
        ...
        orbits.add(orbit4);
        m_configuration.write(actual, location, bridge, false, true, orbits, extensions, true, false, 20);
